...
urlpatterns = [
                  path('change_score', views.change_score, name="change_score"),
                  path('delete_score', views.delete_score, name="delete_score"),
    ...
    path('teacher_view_score', views.teacher_view_score, name="teacher_view_score"),
]
